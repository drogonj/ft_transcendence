...
urlpatterns = [
    ...
    path('api/user/change-username/', views.ChangeUsername.as_view(), name='change-username'),
    path('api/user/change-password/', views.ChangePassword.as_view(), name='change-password'),
